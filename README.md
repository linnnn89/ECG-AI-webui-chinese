...
If you use this repository in academic work, please cite the archived software release DOI when available and cite the associated manuscript after publication. 
...
如在论文、报告或软件项目中使用本仓库，请优先引用 Zenodo 归档版本 DOI；论文发表后请同时引用对应论文。
